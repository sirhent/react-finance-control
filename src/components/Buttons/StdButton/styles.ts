...
const baseButtonVariants = {
  primary_standard: {
    ...
    hover_bg: "product_primary_blue_light",
  ...
  primary_less_important: {
    default_bg: "color_product_primary_4",
    text_color: "color_product_primary",
    border_color: "color_product_primary_blue_light_70",
    hover_bg: "color_product_primary_light",
